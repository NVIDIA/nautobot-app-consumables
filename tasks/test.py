...
def flake8(context: Context, verbose: bool = False, show_source: bool = False) -> None:
    ...
    command.append("nautobot_consumables")
...
def bandit(context: Context) -> None:
    ...
    helpers.run_command(
        context,
        "bandit --recursive nautobot_consumables --configfile .bandit.yml",
    )
...
@task(
    help={
        ...
        "label": "Specify a directory or module to test instead of running all Nautobot tests. "
                 "Default is 'nautobot_consumables`.",
...
def unittests(context: Context, keepdb: bool = False, label: str = "nautobot_consumables",
